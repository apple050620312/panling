...
#更新物品
clear @s leather_boots{id:"panling:pvp2_def_boots"}
item replace entity @s armor.feet with leather_boots{id:"panling:pvp2_def_boots",pvp:1,display:{color:8375321,Name:'[{"translate":"pl.pvp2.item.name.def_boots"},{"text":"+","color":"aqua","italic":false}]',Lore:['{"translate":"pl.pvp.item.limit"}','{"translate":""}','[{"translate":"pl.attribute.armor"},{"text":"2","color":"white","italic":false}]','[{"translate":"pl.attribute.speed"},{"text":"20%","color":"white","italic":false}]','{"translate":""}','{"translate":"pl.pvp.item.uped"}']},AttributeModifiers:[{Slot:"feet",UUID:[I;4,4,4,4],Operation:0,AttributeName:"minecraft:generic.armor",Amount:2},{Slot:"feet",UUID:[I;4,4,4,4],Operation:1,AttributeName:"minecraft:generic.movement_speed",Amount:0.2}],Unbreakable:1b,HideFlags:63,Enchantments:[{id:"binding_curse",lvl:1s}]}
