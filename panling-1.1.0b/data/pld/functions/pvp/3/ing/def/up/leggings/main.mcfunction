...
#更新物品
clear @s leather_leggings{id:"panling:pvp3_def_leggings"}
item replace entity @s armor.legs with chainmail_leggings{id:"panling:pvp3_def_leggings",pvp:1,display:{Name:'[{"translate":"pl.pvp3.item.name.def_leggings"},{"text":"+","color":"aqua","italic":false}]',Lore:['{"translate":"pl.pvp.item.limit"}','{"translate":""}','[{"translate":"pl.attribute.armor"},{"text":"5","color":"white","italic":false}]','{"translate":"pl.pvp.item.lore.arrow_protection"}','{"translate":"pl.pvp.item.lore.protection"}','{"translate":""}','{"translate":"pl.pvp.item.uped"}']},AttributeModifiers:[{Slot:"legs",UUID:[I;3,3,3,3],Operation:0,AttributeName:"minecraft:generic.armor",Amount:5}],Unbreakable:1b,HideFlags:63,Enchantments:[{id:"binding_curse",lvl:1s},{id:"protection",lvl:1s},{id:"projectile_protection",lvl:1s}]}
