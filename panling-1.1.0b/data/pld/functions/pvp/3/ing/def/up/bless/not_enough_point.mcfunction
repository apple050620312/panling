#重置按鈕
clear @s lapis_lazuli{id:"panling:pvp3_def_blessing_up"}
item replace entity @s inventory.0 with lapis_lazuli{id:"panling:pvp3_def_blessing_up",button:1,display:{Name:'{"translate":"pl.pvp.button.name.blessing_up"}',Lore:['{"translate":"pl.pvp.button.lore.click"}','{"translate":"pl.pvp.button.lore.blessing_upa"}','{"translate":"pl.pvp.button.lore.blessing_upb"}','{"translate":"pl.pvp.button.lore.xian3a"}','{"translate":"pl.pvp.button.lore.xian3b"}',]}}
