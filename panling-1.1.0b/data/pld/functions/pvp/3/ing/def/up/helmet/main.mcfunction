...
#更新物品
clear @s chainmail_helmet{id:"panling:pvp3_def_helmet"}
item replace entity @s armor.head with chainmail_helmet{id:"panling:pvp3_def_helmet",pvp:1,display:{Name:'[{"translate":"pl.pvp3.item.name.def_helmet"},{"text":"+","color":"aqua","italic":false}]',Lore:['{"translate":"pl.pvp.item.limit"}','{"translate":""}','[{"translate":"pl.attribute.armor"},{"text":"4","color":"white","italic":false}]','{"translate":"pl.pvp.item.lore.arrow_protection"}','{"translate":""}','{"translate":"pl.pvp.item.uped"}']},AttributeModifiers:[{Slot:"head",UUID:[I;1,1,1,1],Operation:0,AttributeName:"minecraft:generic.armor",Amount:4}],Unbreakable:1b,HideFlags:63,Enchantments:[{id:"binding_curse",lvl:1s},{id:"projectile_protection",lvl:1s}]}
