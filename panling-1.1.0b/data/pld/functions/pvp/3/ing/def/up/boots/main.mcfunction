...
#更新物品
clear @s chainmail_boots{id:"panling:pvp3_def_boots"}
item replace entity @s armor.feet with chainmail_boots{id:"panling:pvp3_def_boots",pvp:1,display:{Name:'[{"translate":"pl.pvp3.item.name.def_boots"},{"text":"+","color":"aqua","italic":false}]',Lore:['{"translate":"pl.pvp.item.limit"}','{"translate":""}','[{"translate":"pl.attribute.armor"},{"text":"4","color":"white","italic":false}]','[{"translate":"pl.attribute.knockback_resistance"},{"text":"100%","color":"white","italic":false}]','{"translate":""}','{"translate":"pl.pvp.item.uped"}']},AttributeModifiers:[{Slot:"feet",UUID:[I;4,4,4,4],Operation:0,AttributeName:"minecraft:generic.armor",Amount:4},{Slot:"feet",UUID:[I;4,4,4,4],Operation:0,AttributeName:"minecraft:generic.knockback_resistance",Amount:1.0}],Unbreakable:1b,HideFlags:63,Enchantments:[{id:"binding_curse",lvl:1s}]}
