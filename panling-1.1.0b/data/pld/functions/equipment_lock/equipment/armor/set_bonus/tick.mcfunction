...
#土四件套-戰
execute if score @s job matches 0 if entity @s[tag=earth_set_4a] unless score @s armor_set_bonus_cool_4_tick matches 1.. if predicate pld:effect_check/absorption run attribute @s generic.attack_damage modifier add 12-4-4-0-0 "土四件套屬性" 0.35 multiply_base
...
#金四件套-聖獸
execute if entity @s[tag=metal_set_4b,scores={job=0,tiger=1}] run attribute @s generic.attack_damage modifier add 12-0-4-1-0 "金聖獸套屬性" 0.15 multiply_base
...
#火四件套-聖獸
execute if entity @s[tag=fire_set_4b,scores={job=0,bird=1}] run attribute @s generic.attack_damage modifier add 12-3-4-1-0 "火聖獸套屬性" 0.15 multiply_base
...
#木四件套-聖獸
execute if entity @s[tag=wood_set_4b,scores={dragon=1}] run attribute @s generic.max_health modifier add 12-1-4-1-0 "木聖獸套屬性" 0.2 multiply_base
execute unless entity @s[tag=wood_set_4b,scores={dragon=1}] run attribute @s generic.max_health modifier remove 12-1-4-1-0

#水四件套-聖獸
execute if entity @s[tag=water_set_4b,scores={turtle=1}] run attribute @s generic.max_health modifier add 12-2-4-1-0 "水聖獸套屬性" 0.2 multiply_base
