...
execute if score @s[tag=metal_set_2_lvl1] job matches 0 run attribute @s generic.attack_damage modifier add 12-0-2-0-0 "金二件套屬性1" 0.08 multiply_base
execute if score @s[tag=metal_set_2_lvl2] job matches 0 run attribute @s generic.attack_damage modifier add 12-0-2-0-1 "金二件套屬性2" 0.08 multiply_base 
