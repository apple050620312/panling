...
execute if score @s job = #temp temp if score #temp temp3 < #temp temp2 run tellraw @s [{"translate": "pl.info.equip_level_limited"},{"nbt":"Items[0].tag.display.Name","block":"~ 255 ~","interpret":true}]
