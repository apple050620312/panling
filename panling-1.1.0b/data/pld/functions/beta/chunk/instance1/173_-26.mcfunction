...
setblock 2783 77 -409 minecraft:command_block{Command:"execute as @p[distance=..10] positioned ~ ~3 ~ run function pld:system/chests/goldchests/instance1/check"} replace 
setblock 2779 77 -413 minecraft:command_block{Command:"execute as @p[x=2779,y=79,z=-413,distance=..3] run function pld:instances/instance1/reward"} replace 
