...
setblock 3311 100 939 minecraft:command_block{Command:"function pld:npcs/xian/guard"} replace 
setblock 3311 100 944 minecraft:command_block{Command:"function pld:npcs/xian/guard"} replace 
setblock 3319 104 939 minecraft:command_block{Command:"function pld:npcs/xian/guard"} replace 
setblock 3319 104 944 minecraft:command_block{Command:"function pld:npcs/xian/guard"} replace 
