...
setblock 3168 48 945 minecraft:command_block{Command:"function pld:npcs/xian/guard"} replace 
setblock 3168 48 933 minecraft:command_block{Command:"function pld:npcs/xian/guard"} replace 
setblock 3178 49 940 minecraft:command_block{Command:"function pld:npcs/xian/chat1"} replace 
setblock 3177 49 940 minecraft:command_block{Command:"function pld:npcs/xian/chat2"} replace 

setblock 3167 50 937 minecraft:command_block{Command:"execute as @p[x=3169,y=52,z=939,distance=..5] run function pld:system/race_tp/race2_out"} destroy
