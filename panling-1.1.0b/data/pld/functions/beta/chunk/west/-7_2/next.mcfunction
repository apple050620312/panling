...
setblock -106 62 46 minecraft:command_block{Command:"function pld:npcs/west/te4"} replace 
setblock -100 52 44 minecraft:command_block{Command:"function pld:npcs/west/te5"} replace 
setblock -106 56 64 minecraft:command_block{Command:"function pld:system/te4/te4tick"} replace 
setblock -96 58 45 minecraft:command_block{Command:"execute as @p[x=-98,y=58,z=45,distance=..5] run function pld:system/te4/reward"} replace 

setblock -100 55 58 minecraft:command_block{Command:"function pld:system/te4/out"} replace 
