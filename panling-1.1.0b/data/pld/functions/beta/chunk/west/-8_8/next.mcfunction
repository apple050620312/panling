...
setblock -119 41 138 minecraft:command_block{Command:"function pld:npcs/west/teshen"} replace 
setblock -124 23 135 minecraft:command_block{Command:"function pld:npcs/west/te6"} replace 
setblock -112 29 132 minecraft:command_block{Command:"function pld:npcs/west/rh4"} replace 
...
setblock -109 34 136 minecraft:command_block{Command:"execute as @p[x=-111,y=34,z=136,distance=..5] run function pld:system/truth/ren/4/check_reward"} replace 
