...
setblock -696 105 -637 minecraft:command_block{Command:"execute as @p[x=-697,y=108,z=-637,distance=..5] run function pld:instances/instance4/in"} replace

setblock -691 103 -644 structure_block{metadata: "", mirror: "NONE", ignoreEntities: 1b, powered: 0b, seed: 0L, author: "?", rotation: "NONE", posX: 0, mode: "LOAD", posY: 1, posZ: 0, integrity: 1.0f, showair: 0b, name: "pld:trader_instance4", showboundingbox: 1b}
