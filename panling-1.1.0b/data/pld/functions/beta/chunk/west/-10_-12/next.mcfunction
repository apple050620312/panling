...
setblock -173 61 -180 minecraft:command_block{Command:"execute as @p[x=-172,y=62,z=-180,distance=..5] run function pld:pvp/3/pre/sign/sign_up_def"} replace 
setblock -170 57 -180 minecraft:command_block{Command:"function pld:npcs/west/pvp3_def"} replace 
