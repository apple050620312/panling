...
setblock 3191 73 380 minecraft:command_block{Command:"execute as @p[x=3192,y=74,z=380,distance=..5] run function pld:system/menubook/update/main"} replace 
...
setblock 3195 71 373 minecraft:command_block{Command:"function pld:npcs/shen/shenmain1"} replace 
setblock 3205 72 378 minecraft:command_block{Command:"tp @p[level=10..,scores={race=0},distance=..10] 3336 128 222 180 -20"} replace 
