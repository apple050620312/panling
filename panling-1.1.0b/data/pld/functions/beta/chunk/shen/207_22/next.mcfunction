...
setblock 3325 111 374 minecraft:command_block{Command:"function pld:npcs/shen/tong5"} replace 
setblock 3325 111 373 minecraft:command_block{Command:"function pld:npcs/shen/tong6"} replace 
setblock 3317 111 354 minecraft:command_block{Command:"function pld:npcs/shen/sh1"} replace 
