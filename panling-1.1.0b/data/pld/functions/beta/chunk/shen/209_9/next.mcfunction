...
setblock 3327 151 152 minecraft:command_block{Command:"function pld:npcs/shen/chat1"} replace 
setblock 3345 151 152 minecraft:command_block{Command:"function pld:npcs/shen/chat2"} replace 
