...
setblock 3334 109 346 minecraft:command_block{Command:"function pld:npcs/shen/chat6"} replace 
setblock 3330 110 350 minecraft:command_block{Command:"function pld:npcs/shen/guard"} replace 
