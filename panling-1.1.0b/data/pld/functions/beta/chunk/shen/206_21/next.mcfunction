...
setblock 3305 109 339 minecraft:command_block{Command:"particle enchant ~ ~3 ~ 0.2 0.2 0.2 0.0 4"} replace 

setblock 3303 108 341 minecraft:command_block{Command:"function pld:npcs/shen/shentong7"} replace 
setblock 3305 110 376 minecraft:command_block{Command:"function pld:npcs/shen/chat7"} replace 
setblock 3298 108 390 minecraft:command_block{Command:"function pld:npcs/shen/se2"} replace 
setblock 3310 110 381 minecraft:command_block{Command:"function pld:npcs/shen/supply0"} replace 
setblock 3311 110 365 minecraft:command_block{Command:"function pld:npcs/shen/guard"} replace 
...
setblock 3311 114 385 minecraft:command_block{Command:"function pld:system/supply/supplymain"} replace 
