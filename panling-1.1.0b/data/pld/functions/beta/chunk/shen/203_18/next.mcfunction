...
setblock 3258 100 289 minecraft:command_block{Command:"function pld:npcs/shen/guard"} replace 
setblock 3249 96 278 minecraft:command_block{Command:"function pld:npcs/shen/guard"} replace 
setblock 3251 93 260 minecraft:command_block{Command:"function pld:npcs/shen/guard"} replace 
