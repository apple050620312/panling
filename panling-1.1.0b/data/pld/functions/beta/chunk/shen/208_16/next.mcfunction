...
setblock 3328 123 259 minecraft:command_block{Command:"function pld:npcs/shen/chat3"} replace 
setblock 3334 123 259 minecraft:command_block{Command:"function pld:npcs/shen/chat4"} replace 
setblock 3344 123 259 minecraft:command_block{Command:"function pld:npcs/shen/chat5"} replace 
setblock 3341 120 271 minecraft:command_block{Command:"function pld:npcs/shen/guard"} replace 
setblock 3333 120 271 minecraft:command_block{Command:"function pld:npcs/shen/guard"} replace 
