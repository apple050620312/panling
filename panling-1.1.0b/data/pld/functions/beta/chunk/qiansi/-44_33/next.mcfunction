...
setblock -704 97 535 minecraft:command_block{Command:"function pld:npcs/qiansi/tong7"} replace 
setblock -702 100 531 minecraft:command_block{Command:"/particle enchant ~ ~3 ~ 0.2 0.2 0.2 0.0 4"} replace 
