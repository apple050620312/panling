...
#要做的事
setblock 1870 42 -1796 minecraft:command_block{Command:"execute as @p[x=1870,y=44,z=-1796,distance=..3] run function pld:pvp/2/ing/atk/check"} replace 
...
setblock 1870 42 -1782 minecraft:command_block{Command:"execute as @p[x=1870,y=44,z=-1782,distance=..2] run function pld:pvp/2/end/atk/reward"} replace 
