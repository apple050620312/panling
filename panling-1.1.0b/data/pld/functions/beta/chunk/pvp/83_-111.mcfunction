...
setblock 1356 49 -1776 minecraft:command_block{Command:"execute as @p[x=1356,y=51,z=-1776,distance=..3] run function pld:pvp/1/ing/atk/check"} replace 
setblock 1343 49 -1776 minecraft:command_block{Command:"execute as @p[x=1343,y=51,z=-1776,distance=..2] run function pld:pvp/1/end/atk/reward"} replace 

setblock 1372 53 -1772 minecraft:command_block{Command:"tp @a[distance=..3] 1445 125 -1719 180 0"} replace 
setblock 1376 53 -1776 minecraft:command_block{Command:"tp @a[distance=..3] 1399 107 -1772 135 30"} replace 
setblock 1372 53 -1780 minecraft:command_block{Command:"tp @a[distance=..3] 1319 104 -1876 -45 -20"} replace 
