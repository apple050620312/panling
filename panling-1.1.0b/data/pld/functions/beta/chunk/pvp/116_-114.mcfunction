...
#要做的事
setblock 1870 42 -1814 minecraft:command_block{Command:"execute as @p[x=1870,y=44,z=-1814,distance=..3] run function pld:pvp/2/ing/def/check"} replace 
...
setblock 1870 42 -1827 minecraft:command_block{Command:"execute as @p[x=1870,y=44,z=-1827,distance=..2] run function pld:pvp/2/end/def/reward"} replace 
