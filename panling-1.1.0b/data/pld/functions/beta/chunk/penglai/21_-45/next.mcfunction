...
setblock 335 31 -722 minecraft:repeating_command_block{Command:"function pld:system/into_laojunroom"} replace 
setblock 338 31 -722 minecraft:repeating_command_block{Command:"function pld:system/into_laojunroom"} replace 
setblock 340 28 -716 minecraft:command_block{Command:"function pld:npcs/penglai/tong1a"} replace 
setblock 337 12 -716 minecraft:command_block{Command:"function pld:npcs/penglai/yh5"} replace 
setblock 332 31 -718 minecraft:command_block{Command:"execute as @p[x=332,y=33,z=-718,distance=..3] run function pld:system/into_laojundf"} replace 

setblock 337 31 -722 minecraft:command_block{Command:"/tp @p[x=336,y=33,z=-722,dx=1,dy=0,dz=1] 336 33 -724"} replace 
setblock 336 31 -722 minecraft:command_block{Command:"/tp @p[x=336,y=33,z=-722,dx=1,dy=0,dz=1] 336 33 -724"} replace 
...
setblock 339 17 -720 minecraft:command_block{Command:"execute as @p[x=339,y=17,z=-718,distance=..5] run function pld:system/truth/yao/5/check_reward"} replace 
