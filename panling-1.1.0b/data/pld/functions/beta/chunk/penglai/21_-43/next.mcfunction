...
setblock 345 50 -681 minecraft:command_block{Command:"particle enchant ~ ~3 ~ 0.2 0.2 0.2 0.0 4"} replace 
setblock 341 48 -684 minecraft:command_block{Command:"function pld:npcs/penglai/rentong7"} replace
setblock 353 50 -674 minecraft:command_block{Command:"execute as @p[x=353,y=52,z=-674,distance=..2] run function pld:system/into_penglaidf"} replace
