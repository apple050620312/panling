...
setblock 2728 37 857 minecraft:command_block{Command:"function pld:npcs/yao/guard"} replace 
setblock 2720 38 851 minecraft:command_block{Command:"function pld:npcs/yao/guard"} replace 

setblock 2735 39 849 minecraft:command_block{Command:"function pld:npcs/yao/chat3"} replace 
setblock 2739 39 863 minecraft:command_block{Command:"function pld:npcs/yao/chat4"} replace 
setblock 2723 36 855 minecraft:command_block{Command:"function pld:npcs/yao/supply1"} replace 

data merge block 2723 42 857 {front_text:{messages:['{"translate":""}','{"translate":"pl.sign.supply.text2"}','{"translate":""}','{"translate":""}']}}

setblock 2723 40 858 minecraft:command_block{Command:"function pld:system/supply/supplymain"} replace 
