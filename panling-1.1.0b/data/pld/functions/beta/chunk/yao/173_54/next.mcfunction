...
setblock 2785 49 864 minecraft:command_block{Command:"function pld:npcs/yao/yaomain2"} replace 
setblock 2777 47 873 minecraft:command_block{Command:"function pld:npcs/yao/chat8"} replace 
setblock 2795 50 865 minecraft:command_block{Command:"function pld:npcs/yao/guard"} replace 
setblock 2775 49 860 minecraft:command_block{Command:"function pld:npcs/yao/guard"} replace 
