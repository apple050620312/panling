...
setblock 1654 150 176 minecraft:command_block{Command:"function pld:npcs/ren/renmain4"} replace 
setblock 1655 150 176 minecraft:command_block{Command:"function pld:npcs/ren/rentong4"} replace 
setblock 1664 145 171 minecraft:command_block{Command:"function pld:npcs/ren/chat11"} replace 
setblock 1692 152 166 minecraft:command_block{Command:"function pld:npcs/ren/chat3"} replace 
setblock 1648 150 166 minecraft:command_block{Command:"function pld:npcs/ren/guard"} replace 
setblock 1687 140 169 minecraft:command_block{Command:"function pld:npcs/ren/guard"} replace 
