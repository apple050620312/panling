...
setblock 1670 136 132 minecraft:command_block{Command:"execute as @p[x=1671,y=137,z=132,distance=..5] run function pld:system/menubook/update/main"} destroy
...
setblock 1666 136 141 minecraft:command_block{Command:"function pld:system/rechoose/rechoose"} replace

setblock 1667 143 127 minecraft:command_block{Command:"function pld:npcs/ren/chat1"} replace 
