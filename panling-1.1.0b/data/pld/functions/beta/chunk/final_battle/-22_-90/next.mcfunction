...
setblock -342 207 -1440 minecraft:command_block{Command:"function pld:instances/ture_pangu/final_battle_plan"} replace
setblock -347 202 -1448 minecraft:command_block{Command:"function pld:npcs/final_story/1"} replace
setblock -346 202 -1449 minecraft:command_block{Command:"function pld:npcs/final_story/2"} replace
setblock -345 202 -1449 minecraft:command_block{Command:"function pld:npcs/final_story/3"} replace
setblock -346 202 -1448 minecraft:command_block{Command:"function pld:npcs/final_story/4"} replace
setblock -345 202 -1448 minecraft:command_block{Command:"function pld:npcs/final_story/5"} replace
setblock -344 202 -1448 minecraft:command_block{Command:"function pld:npcs/final_story/6"} replace
setblock -345 202 -1447 minecraft:command_block{Command:"function pld:npcs/final_story/7"} replace
setblock -344 202 -1447 minecraft:command_block{Command:"function pld:npcs/final_story/8"} replace
setblock -344 202 -1446 minecraft:command_block{Command:"function pld:npcs/final_story/9"} replace
setblock -343 202 -1447 minecraft:command_block{Command:"function pld:npcs/final_story/10"} replace
setblock -342 202 -1446 minecraft:command_block{Command:"function pld:npcs/final_story/11"} replace
