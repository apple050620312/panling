...
setblock 3264 17 -248 minecraft:command_block{Command:"function pld:npcs/zhan/guard2"} replace 
#206 -16
setblock 3299 19 -254 minecraft:command_block{Command:"function pld:npcs/zhan/zhanmain3"} replace 
data merge block 3306 23 -253 {CustomName:'{"translate":"pl.name.dzt"}'}
#205 -16
setblock 3287 19 -241 minecraft:command_block{Command:"function pld:npcs/zhan/zhantong1"} replace 
#205 -17
setblock 3286 20 -267 minecraft:command_block{Command:"function pld:npcs/zhan/zhantong2"} replace 
setblock 3287 20 -267 minecraft:command_block{Command:"function pld:npcs/zhan/zhantong3"} replace 
