...
#要做的事
setblock 3303 15 -162 minecraft:command_block{Command:"function pld:npcs/zhan/chat7"} replace 
setblock 3301 15 -163 minecraft:command_block{Command:"function pld:npcs/zhan/chat8"} replace 
