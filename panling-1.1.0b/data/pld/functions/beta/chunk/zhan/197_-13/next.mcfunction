...
setblock 3161 34 -193 minecraft:command_block{Command:"function pld:npcs/zhan/guard2"} replace 
setblock 3161 34 -201 minecraft:command_block{Command:"function pld:npcs/zhan/guard2"} replace 
setblock 3139 41 -194 minecraft:command_block{Command:"function pld:npcs/zhan/guard2"} replace 
setblock 3139 41 -200 minecraft:command_block{Command:"function pld:npcs/zhan/guard2"} replace 
setblock 3162 33 -204 minecraft:command_block{Command:"function pld:npcs/zhan/chat13"} replace
...
setblock 3138 43 -197 minecraft:command_block{Command:"execute as @p[x=3138,y=45,z=-197,distance=..3] run function pld:test/zhan/incheck"} replace 
