...
setblock 1282 76 -8 minecraft:command_block{Command:"execute as @p[x=1282,y=78,z=-8,distance=..2] run function pld:selections/race/select4"} replace 
setblock 1284 73 -5 minecraft:command_block{Command:"function pld:npcs/select/leading_ren"} replace
