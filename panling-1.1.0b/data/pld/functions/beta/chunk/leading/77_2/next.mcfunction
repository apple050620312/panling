...
setblock 1233 74 42 minecraft:command_block{Command:"execute as @p[x=1233,y=76,z=42,distance=..2] run function pld:selections/race/select0"} replace 
setblock 1242 73 45 minecraft:command_block{Command:"function pld:npcs/select/leading_shen"} replace
