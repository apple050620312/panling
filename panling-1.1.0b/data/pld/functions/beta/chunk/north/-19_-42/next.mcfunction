#要做的事
setblock -301 18 -659 minecraft:command_block{Command:"function pld:npcs/north/northtong"} replace 
setblock -301 14 -677 minecraft:command_block{Command:"function pld:npcs/north/northmain1"} replace
setblock -289 17 -666 minecraft:command_block{Command:"function pld:npcs/north/chat2"} replace 
