#要做的事
setblock -335 93 -445 minecraft:command_block{Command:"function pld:npcs/north/xh5"} replace
...
setblock -328 98 -445 minecraft:command_block{Command:"execute as @p[x=-330,y=97,z=-445,distance=..5] run function pld:system/truth/xian/5/check_reward"} replace
