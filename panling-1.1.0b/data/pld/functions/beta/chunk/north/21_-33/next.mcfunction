...
setblock 346 31 -541 minecraft:command_block{Command:"execute as @p[x=345,y=33,z=-541,distance=..5] run function pld:system/tppenglai"} replace 
setblock 345 31 -541 minecraft:command_block{Command:"execute as @p[x=345,y=33,z=-541,distance=..5] run function pld:system/tppenglai"} replace 

setblock 354 31 -515 minecraft:command_block{Command:"function pld:npcs/north/chat3"} replace 
