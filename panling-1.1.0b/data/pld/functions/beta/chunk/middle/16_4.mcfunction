...
data merge block 288 44 68 {Lock:"§b城東乾府的鑰匙",CustomName:'{"translate":"pl.chest.home_open_chest"}'}
data merge block 288 44 70 {Lock:"§b城東乾府的鑰匙",CustomName:'{"translate":"pl.chest.home_open_chest"}'}

data merge block 261 46 71 {Lock:"§b城東坤府的鑰匙",CustomName:'{"translate":"pl.chest.home_open_chest"}'}
data merge block 261 46 69 {Lock:"§b城東坤府的鑰匙",CustomName:'{"translate":"pl.chest.home_open_chest"}'}
