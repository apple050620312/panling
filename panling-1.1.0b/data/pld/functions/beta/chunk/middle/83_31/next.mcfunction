...
setblock 1329 37 491 minecraft:command_block{Command:"execute as @p[x=1329,y=38,z=492,distance=..5] run function pld:system/honor_shop/item22"} replace
...
setblock 1340 37 491 minecraft:command_block{Command:"execute as @p[x=1340,y=38,z=492,distance=..5] run function pld:system/honor_shop/item23"} replace
...
setblock 1346 38 495 minecraft:command_block{Command:"execute as @p[x=1348,y=38,z=495,distance=..5] run function pld:system/honor_shop/enchant1/check"} destroy
...
setblock 1346 38 493 minecraft:command_block{Command:"execute as @p[x=1348,y=38,z=493,distance=..5] run function pld:system/honor_shop/enchant2/check"} destroy
...
setblock 1349 38 489 minecraft:command_block{Command:"execute as @p[x=1349,y=38,z=491,distance=..5] run function pld:system/honor_shop/enchant3/check"} destroy
...
setblock 1351 38 489 minecraft:command_block{Command:"execute as @p[x=1351,y=38,z=491,distance=..5] run function pld:system/honor_shop/enchant4/check"} destroy
...
setblock 1353 38 489 minecraft:command_block{Command:"execute as @p[x=1353,y=38,z=491,distance=..5] run function pld:system/honor_shop/enchant5/check"} destroy
...
setblock 1356 38 493 minecraft:command_block{Command:"execute as @p[x=1354,y=38,z=493,distance=..5] run function pld:system/honor_shop/enchant6/check"} destroy
...
setblock 1356 38 495 minecraft:command_block{Command:"execute as @p[x=1354,y=38,z=495,distance=..5] run function pld:system/honor_shop/enchant7/check"} destroy
...
setblock 1346 35 497 minecraft:command_block{Command:"particle enchant ~ ~5 ~ 0.2 0.2 0.2 0.0 20"} replace
setblock 1351 35 494 minecraft:command_block{Command:"particle minecraft:happy_villager ~ ~5 ~-1 3 3 3 1 50"} replace
