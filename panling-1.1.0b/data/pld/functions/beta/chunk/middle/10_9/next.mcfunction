...
setblock 162 7 139 minecraft:command_block{Command:"function pld:npcs/middle/chat70"} replace 

setblock 170 9 134 minecraft:command_block{Command:"tp @p[x=170,y=12,z=135,distance=..2] 175 48 160"} replace
setblock 170 9 159 minecraft:command_block{Command:"tp @p[x=170,y=12,z=160,distance=..2] 175 48 160"} replace
setblock 170 44 159 minecraft:command_block{Command:"tp @p[x=170,y=47,z=160,distance=..2] 175 48 160"} replace 
