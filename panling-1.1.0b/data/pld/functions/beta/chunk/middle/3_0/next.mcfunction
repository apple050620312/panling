...
setblock 54 2 27 minecraft:command_block{Command:"function pld:npcs/middle/te27"} replace 
setblock 54 2 17 minecraft:command_block{Command:"function pld:npcs/middle/chat03"} replace 
setblock 60 44 34 minecraft:command_block{Command:"function pld:npcs/middle/chat53"} replace 

setblock 56 4 32 minecraft:command_block{Command:"playsound random.door_open ambient @p 56 48 34 3"} replace 
setblock 57 4 32 minecraft:command_block{Command:"tp @p[distance=..5] 56 48 34"} replace 
...
setblock 50 42 32 minecraft:command_block{Command:"particle witch 51.208 49 32.242 0.5 0.5 0.5 1 20"} replace 
setblock 51 43 32 minecraft:command_block{Command:'tellraw @a[x=50,y=48,z=31,distance=..5] {"translate":"pl.info.armor_stand7"}'} replace 
