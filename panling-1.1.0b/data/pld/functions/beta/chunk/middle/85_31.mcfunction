...
setblock 1363 36 507 minecraft:command_block{Command:"execute as @e[x=1357,y=41,z=511,type=armor_stand,distance=..3,limit=1] at @s run particle crit ~ ~2 ~-0.9 0 0 0 0.2 10"} replace
...
setblock 1382 37 511 minecraft:command_block{Command:"execute as @p[x=1381,y=38,z=511,distance=..5] run function pld:system/honor_shop/item24"} replace
