...
setblock 1300 40 645 minecraft:command_block{Command:"function pld:selections/stories/2_1"} replace
setblock 1308 40 645 minecraft:command_block{Command:"function pld:selections/stories/2_2"} replace
setblock 1316 40 645 minecraft:command_block{Command:"function pld:selections/stories/2_3"} replace

setblock 1322 39 647 minecraft:command_block{Command:"tp @p[x=1321,y=42,z=646,distance=..3] 1204 27 -381 -90 0"} replace

setblock 1300 40 642 minecraft:command_block{Command:"/particle happy_villager 1302 42 642 0.1 2 0.2 0 50"} replace
setblock 1306 40 642 minecraft:command_block{Command:"/particle happy_villager 1308 43 642 0.7 0.7 0.7 0 50"} replace
