...
setblock 205 52 -1759 minecraft:command_block{Command:"execute as @p[x=205,y=54,z=-1759,distance=..7] run function pld:system/rechoose/rechoose_back"} replace 
setblock 205 52 -1753 minecraft:command_block{Command:"execute as @p[x=205,y=54,z=-1753,distance=..7] run function pld:system/rechoose/rechoose_agree"} replace 
