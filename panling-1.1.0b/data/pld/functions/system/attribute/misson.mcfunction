...
attribute @s[scores={ex_te32=1}] minecraft:generic.armor modifier add 0-0-1-0-4 "雨竹支線獎勵-護甲" 2 add 
...
attribute @s[scores={ex_doctor=1}] minecraft:generic.max_health modifier add 0-0-1-0-0 "李大夫支線獎勵-生命" 2 add 
attribute @s[scores={ex_sunday=3}] minecraft:generic.armor_toughness modifier add 0-0-1-0-3 "辛齊天支線獎勵-韌性" 1 add
attribute @s[scores={ex_sword=1}] minecraft:generic.max_health modifier add 0-0-1-0-2 "劍意支線獎勵-生命" 2 add 

attribute @s[scores={race=0,finish_shen_hide=1}] minecraft:generic.max_health modifier add 0-0-1-1-0 "神族隱藏獎勵-生命" 2 add 
attribute @s[scores={race=1,finish_yao_hide=1}] minecraft:generic.max_health modifier add 0-0-1-1-1 "妖族隱藏獎勵-生命" 2 add 
attribute @s[scores={race=2,finish_xian_hide=1}] minecraft:generic.max_health modifier add 0-0-1-1-2 "仙族隱藏獎勵-生命" 2 add 
attribute @s[scores={race=3,finish_zhan_hide=1}] minecraft:generic.max_health modifier add 0-0-1-1-3 "戰神族隱藏獎勵-生命" 2 add 
attribute @s[scores={race=4,finish_ren_hide=1}] minecraft:generic.max_health modifier add 0-0-1-1-4 "人族隱藏獎勵-生命" 2 add 
