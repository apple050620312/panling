data modify storage pld:system Temp_player_new_mails append value {sent:"§b凌霄閣閣主-羅元上仙",is_taked:0b,title:'{"translate":"pl.mail.supply.name"}',content:['{"translate":"pl.mail.supply_plus.lore.a"}','{"translate":"pl.mail.supply_plus.lore.b"}','{"translate":"pl.mail.supply_plus.lore.c"}'],attached_items:[]}
