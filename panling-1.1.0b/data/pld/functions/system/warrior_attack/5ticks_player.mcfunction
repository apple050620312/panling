...
execute as @s[scores={weapon_skill_axe2_5ticks=0..}] unless entity @s[nbt={SelectedItem:{tag:{id:"panling:axe2",act:1}}}] run scoreboard players set @s weapon_skill_axe2_5ticks -1
    #粒子效果
...
execute as @s[scores={weapon_skill_axe4_5ticks=0..}] unless entity @s[nbt={SelectedItem:{tag:{id:"panling:axe4",act:1}}}] run scoreboard players set @s weapon_skill_axe4_5ticks -1
...
execute as @s[scores={weapon_skill_axe5_5ticks=0..}] unless entity @s[nbt={SelectedItem:{tag:{id:"panling:axe5",act:1}}}] run scoreboard players set @s weapon_skill_axe5_5ticks -1
