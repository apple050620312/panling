...
attribute @s minecraft:generic.max_health modifier add 0-0-0-2-0 "神族支線獎勵-生命" 2 add 
attribute @s minecraft:generic.armor_toughness modifier add 0-0-0-2-0 "神族支線獎勵-韌性" 1 add
