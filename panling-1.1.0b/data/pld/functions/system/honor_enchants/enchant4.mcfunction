...
attribute @s generic.movement_speed modifier add 7-7-7-7-7 "時裝附靈速度值" 0.2 multiply_base
attribute @s[scores={hp_precent=100}] generic.movement_speed modifier add 7-7-7-7-8 "時裝附靈速度值" 0.2 multiply_base
