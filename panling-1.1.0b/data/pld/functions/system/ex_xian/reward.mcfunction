...
attribute @s minecraft:generic.max_health modifier add 0-0-0-2-2 "仙族支線獎勵-生命" 2 add 
attribute @s minecraft:generic.knockback_resistance modifier add 0-0-0-2-2 "仙族支線獎勵-抗性" 0.2 add
