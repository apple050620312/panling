...
attribute @s minecraft:generic.max_health modifier add 0-0-0-2-1 "妖族支線獎勵-生命" 2 add 
attribute @s minecraft:generic.movement_speed modifier add 0-0-0-2-1 "妖族支線獎勵-速度" 0.05 multiply_base
