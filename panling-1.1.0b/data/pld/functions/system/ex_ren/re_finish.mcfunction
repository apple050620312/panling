...
attribute @s minecraft:generic.max_health modifier add 0-0-0-2-4 "人族支線獎勵-生命" 2 add 
attribute @s minecraft:generic.armor_toughness modifier add 0-0-0-2-4 "人族支線獎勵-韌性" 1 add
