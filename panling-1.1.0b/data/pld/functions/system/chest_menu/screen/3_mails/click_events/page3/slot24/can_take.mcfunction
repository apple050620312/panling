...
#將本條目設置爲不可領取
data modify storage pld:system Temp_ender_data.mails[61].is_taked set value 1b
#更新儲存數據
...
#返還本位置可能存在的物品
function pld:system/chest_menu/screen/3_mails/click_events/return/slot24

#重置本按鈕
function pld:system/chest_menu/screen/3_mails/buttons/page3/slot24