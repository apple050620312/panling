...
#物品&標題
execute if data storage pld:system Temp_the_mail{is_taked:0b} run item replace entity @s enderchest.14 with experience_bottle{clickable:1,take_id:14,HideFlags:63}
execute if data storage pld:system Temp_the_mail{is_taked:1b} run item replace entity @s enderchest.14 with paper{clickable:1,take_id:14,HideFlags:63}
