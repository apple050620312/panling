...
give @s[scores={race=0}] minecraft:green_dye{display:{Lore:['{"translate":"pl.item.lore.zm0"}'],Name:'{"translate":"pl.item.name.zm0"}'},id:"panling:zm_shen"} 64
give @s[scores={race=1}] minecraft:purple_dye{display:{Lore:['{"translate":"pl.item.lore.zm1"}'],Name:'{"translate":"pl.item.name.zm1"}'},id:"panling:zm_yao"} 64
give @s[scores={race=2}] minecraft:lapis_lazuli{display:{Lore:['{"translate":"pl.item.lore.zm2"}'],Name:'{"translate":"pl.item.name.zm2"}'},id:"panling:zm_xian"} 64
give @s[scores={race=3}] minecraft:red_dye{display:{Lore:['{"translate":"pl.item.lore.zm3"}'],Name:'{"translate":"pl.item.name.zm3"}'},id:"panling:zm_zhan"} 64
give @s[scores={race=4}] minecraft:cocoa_beans{display:{Lore:['{"translate":"pl.item.lore.zm4"}'],Name:'{"translate":"pl.item.name.zm4"}'},id:"panling:zm_ren"} 64
