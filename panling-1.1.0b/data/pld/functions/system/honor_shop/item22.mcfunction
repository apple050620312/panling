...
give @s[tag=buy_success] minecraft:black_dye{id:"panling:housekey_sky",display:{Name:'{"text":"§b城東乾府的鑰匙"}',Lore:['{"translate":"pl.item.lore.housekeya"}','{"translate":"pl.item.lore.housekeyb"}']}} 5
