...
give @s[tag=buy_success] minecraft:black_dye{id:"panling:housekey_earth",display:{Name:'{"text":"§b城東坤府的鑰匙"}',Lore:['{"translate":"pl.item.lore.housekeya"}','{"translate":"pl.item.lore.housekeyb"}']}} 5
scoreboard players remove @s[tag=buy_success] honor 2000
execute as @s[tag=buy_success] run setblock 1340 38 492 minecraft:oak_sign{front_text:{messages:['{"translate":""}','{"translate":"pl.spsign.honor_exchange23_sold.text2"}']}} replace
