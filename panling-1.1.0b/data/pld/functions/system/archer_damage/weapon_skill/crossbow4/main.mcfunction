#提供效果
#給予玩家移動速度加成
attribute @p[tag=shooter] generic.movement_speed modifier add 11-5-5-5-1 "蛟龍弩-武器技速度加成-1" 0.04 multiply_base
attribute @p[tag=shooter] generic.movement_speed modifier add 11-5-5-5-2 "蛟龍弩-武器技速度加成-2" 0.04 multiply_base
attribute @p[tag=shooter] generic.movement_speed modifier add 11-5-5-5-3 "蛟龍弩-武器技速度加成-3" 0.04 multiply_base
attribute @p[tag=shooter] generic.movement_speed modifier add 11-5-5-5-4 "蛟龍弩-武器技速度加成-4" 0.04 multiply_base
attribute @p[tag=shooter] generic.movement_speed modifier add 11-5-5-5-5 "蛟龍弩-武器技速度加成-5" 0.04 multiply_base
