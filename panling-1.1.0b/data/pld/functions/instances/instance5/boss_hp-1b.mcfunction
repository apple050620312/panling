...
#清除玩家身上的道具
clear @a[x=2992,y=0,z=-2000,dx=271,dy=255,dz=303] slime_ball{id:"panling:instance5_dirt"}
clear @a[x=2992,y=0,z=-2000,dx=271,dy=255,dz=303] snowball{id:"panling:instance5_snowball"}
#傳送玩家
