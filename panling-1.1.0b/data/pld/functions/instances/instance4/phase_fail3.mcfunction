...
tellraw @a[x=912,y=57,z=1214,dx=62,dy=52,dz=70] {"translate": "pl.info.instance4.fail3"}
...
#大魚回血
effect give @e[type=elder_guardian,x=912,y=57,z=1214,dx=62,dy=52,dz=70] instant_health 1 10
