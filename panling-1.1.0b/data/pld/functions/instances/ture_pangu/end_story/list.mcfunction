execute if score #system conversation_end_story matches 105 run function pld:instances/ture_pangu/end_story/105
execute if score #system conversation_end_story matches 104 run function pld:instances/ture_pangu/end_story/104
execute if score #system conversation_end_story matches 103 run function pld:instances/ture_pangu/end_story/103
execute if score #system conversation_end_story matches 102 run function pld:instances/ture_pangu/end_story/102
execute if score #system conversation_end_story matches 101 run function pld:instances/ture_pangu/end_story/101
execute if score #system conversation_end_story matches 100 run function pld:instances/ture_pangu/end_story/100
