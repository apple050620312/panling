...
#tellraw @a  {text:"",extra:[{text:"◎ 神族",color:aqua},{selector:"@r[2992,0,-2000,dx=241,dy=255,dz=303,score_racemission0_min=1]",color:aqua},{text:"：",color:aqua},{text:"你錯了......",color:white},{text:"盤古",color:gold},{text:"與我們",color:white},{text:"神族",color:aqua},{text:"其實",color:white},{text:"並不屬於這個世界",color:red},{text:"，",color:white},{text:"妖族",color:green},{text:"纔是這個世界的",color:white},{text:"原住民",color:green},{text:"。這也是為什麼我們被",color:white},{text:"世界的意志-也就是天道-制約",color:gold,bold:true},{text:"而沒有辦法對",color:white},{text:"妖族",color:green},{text:"出手。",color:white}]}
#對話延遲
