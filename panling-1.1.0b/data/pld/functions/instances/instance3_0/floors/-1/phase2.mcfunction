...
#召喚boss
summon minecraft:zombie 2791 31 -763 {Team:"monster",Tags:["panling","undead","monster","in30_boss1"],PersistenceRequired:1,Silent:1,CanPickUpLoot:false,ArmorDropChances:[0f,0f,0f,0f],HandDropChances:[0f,0f],CustomNameVisible:1b,CustomName:'{"translate":"pl.monster.instance3_0.boss1"}',DeathLootTable:"pld:empty",Health:400.0f,Attributes:[{Name:"generic.max_health",Base:400d},{Name:"generic.movement_speed",Base:0.3d},{Name:"generic.attack_damage",Base:5d},{Name:"generic.follow_range",Base:100d},{Name:"generic.knockback_resistance",Base:1d}],ArmorItems:[{id:"minecraft:chainmail_boots",Count:1b,tag:{Unbreakable:1b}},{id:"minecraft:chainmail_leggings",Count:1b,tag:{Unbreakable:1b}},{id:"minecraft:chainmail_chestplate",Count:1b,tag:{Unbreakable:1b}},{id:"minecraft:lime_terracotta",Count:1b}],HandItems:[{id:"golden_sword",Count:1b,tag:{Unbreakable:1}},{}]}
#boss技能tick
