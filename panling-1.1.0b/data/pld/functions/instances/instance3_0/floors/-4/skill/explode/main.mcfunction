#召喚黑白兩個傀儡
summon skeleton 2834 31 -839 {Team:"monster",Tags:["panling","undead","monster","in3_monster"],Silent:1b,HandDropChances:[0f,0f],ArmorDropChances:[0f,0f,0f,0f],CustomNameVisible:1b,CustomName:'{"translate":"pl.monster.instance3_0.skeleton"}',ArmorItems:[{},{},{},{id:"minecraft:end_stone",Count:1b}],Health:800.0f,DeathLootTable:"pld:instance3/in3_0_white",Attributes:[{Name:"generic.max_health",Base:800d},{Name:"generic.follow_range",Base:30d},{Name:"generic.movement_speed",Base:0.2d},{Name:"generic.attack_damage",Base:5d},{Name:"generic.knockback_resistance",Base:1d}],CanPickUpLoot:false}
summon wither_skeleton 2834 31 -859 {Team:"monster",Tags:["panling","undead","monster","in3_monster"],Silent:1b,HandDropChances:[0f,0f],ArmorDropChances:[0f,0f,0f,0f],CustomNameVisible:1b,CustomName:'{"translate":"pl.monster.instance3_0.wither_skeleton"}',ArmorItems:[{},{},{},{id:"minecraft:bedrock",Count:1b}],Health:800.0f,DeathLootTable:"pld:instance3/in3_0_black",Attributes:[{Name:"generic.max_health",Base:800d},{Name:"generic.follow_range",Base:30d},{Name:"generic.movement_speed",Base:0.2d},{Name:"generic.attack_damage",Base:5d},{Name:"generic.knockback_resistance",Base:1d}],CanPickUpLoot:false}
