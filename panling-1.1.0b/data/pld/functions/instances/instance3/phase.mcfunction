...
execute if entity @e[type=item,nbt={Item:{id:"minecraft:black_wool",tag:{instance:3}}}] run scoreboard players set #system instance3_skill 1
execute if entity @e[type=item,nbt={Item:{id:"minecraft:white_wool",tag:{instance:3}}}] run scoreboard players set #system instance3_skill 0
execute as @e[type=item,nbt={Item:{tag:{instance:3}}}] run kill @s
