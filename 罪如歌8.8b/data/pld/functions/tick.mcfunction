...
#==================================非玩家實體tick=================================#
execute as @e[type=!player,type=!item_frame,type=!glow_item_frame,type=!bat,type=!villager,type=!falling_block,type=!experience_orb] run function pld:ticks/entity/entity_check

#==================================落沙刷怪tick=================================#
execute as @e[type=falling_block,tag=east] run function pld:monsters/east/pos
execute as @e[type=falling_block,tag=south] run function pld:monsters/south/pos
execute as @e[type=falling_block,tag=west] run function pld:monsters/west/pos
execute as @e[type=falling_block,tag=north] run function pld:monsters/north/pos
execute as @e[type=falling_block,tag=te17] run function pld:monsters/te17/pos
execute as @e[type=falling_block,tag=instance1] run function pld:monsters/instance1/pos
execute as @e[type=falling_block,tag=instance2] run function pld:monsters/instance2/pos
execute as @e[type=falling_block,tag=instance3] run function pld:monsters/instance3/pos
execute as @e[type=falling_block,tag=instance4] run function pld:monsters/instance4/pos
execute as @e[type=falling_block,tag=test_ren] run function pld:monsters/test_ren/pos
execute as @e[type=falling_block,tag=test_zhan] run function pld:monsters/test_zhan/pos
execute as @e[type=falling_block,tag=final_battle] run function pld:monsters/final_battle/pos
