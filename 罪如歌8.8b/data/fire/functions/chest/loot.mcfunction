...
kill @e[type=item,limit=1,sort=nearest,nbt={Item:{tag:{fire:1}}}]
#loot spawn ~ ~ ~ loot fire:goldchest
loot spawn ~ ~ ~ loot fire:goldchest
execute as @e[limit=1,type=item,sort=nearest,nbt={Item:{tag:{fire:1,chest:3}}}] run function fire:chest/judge
