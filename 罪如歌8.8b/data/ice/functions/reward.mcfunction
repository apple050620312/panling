...
give @s orange_dye{Enchantments:[{id:"minecraft:protection",lvl:1s}],HideFlags:63,display:{Lore:['{"translate":"in.ice.collection.lore"}','{"translate":"pl.item.lore.instance2_collectionb"}'],Name:'{"translate":"in.ice.collection.name"}'},id:"ice:collection",dlc:"collection"} 2
...
tp @s -105 33 -219
advancement grant @s only dlc:adv/instances/ice