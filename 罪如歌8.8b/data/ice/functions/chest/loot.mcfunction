...
kill @e[type=item,limit=1,sort=nearest,nbt={Item:{tag:{ice:1}}}]
#loot spawn ~ ~ ~ loot ice:goldchest
loot spawn ~ ~ ~ loot ice:goldchest
execute as @e[limit=1,type=item,sort=nearest,nbt={Item:{tag:{ice:1,chest:3}}}] run function ice:chest/judge
