...
give @s orange_dye{Enchantments:[{id:"minecraft:protection",lvl:1s}],HideFlags:63,display:{Lore:['{"translate":"in.dream.collection.lore.a"}','{"translate":"in.dream.collection.lore.b"}','{"translate":"in.dream.collection.lore.c"}'],Name:'{"translate":"in.dream.collection.name"}'},id:"dream:collection",dlc:"collection"} 2
...
tp @s 179 43 63
advancement grant @s only dlc:adv/instances/dream
