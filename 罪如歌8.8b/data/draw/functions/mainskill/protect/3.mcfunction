...
execute if score #dlc draw_on matches 2 if score #dlc draw.bossskill.fall matches 100.. run scoreboard players operation #temp temp %= #system 2

execute if score #dlc draw_on matches 2 if score #dlc draw.bossskill.fall matches 100.. if score #temp temp matches 0 positioned 655 25 -1920 run summon marker ~ ~ ~ {Tags:["draw.bossskill1.marker"]}
