...
execute if score #dlc draw_on matches 2 if score #dlc draw.bossskill.fall matches 100.. positioned 655 52 -1920 run summon marker ~ ~ ~ {Tags:["draw.bossskill1.marker"]}
