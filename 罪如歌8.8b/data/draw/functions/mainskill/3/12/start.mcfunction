...
execute positioned 655 12 -1920 run function dlc:dz/weapon/sins/21/4
...
execute if score #dlc draw.bossskill.protect matches 0 as @e[tag=draw_boss] run attribute @s generic.movement_speed modifier add 2025-6-9-0-1 "boss驚鴻移動速度加成" 0.5 multiply_base

tellraw @a[scores={dlc_ins=5}] [{"text":"負罪者繪出","color": "aqua"},{"text":"流星照驚鴻","color": "red"},{"text":"進行戰鬥","color": "aqua"}]
tellraw @a[scores={dlc_ins=5}] [{"text":"流星照驚鴻","color": "red"},{"text":"在手，負罪者每次造成箭矢傷害時，都會對所有玩家造成10點真實傷害","color": "aqua"}]
