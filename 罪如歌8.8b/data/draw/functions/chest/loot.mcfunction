...
kill @e[type=item,limit=1,sort=nearest,nbt={Item:{tag:{draw:1}}}]
#loot spawn ~ ~ ~ loot draw:goldchest
loot spawn ~ ~ ~ loot draw:goldchest
execute as @e[limit=1,type=item,sort=nearest,nbt={Item:{tag:{draw:1,chest:3}}}] run function draw:chest/judge
