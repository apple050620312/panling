#由 子marker 執行
scoreboard players set #system temp6 10000
...
#execute store result score #random int run data get entity @s UUID[0]
#scoreboard players operation #random int %= 700 int
#execute store result score #x int run data get entity @s Motion[0] 1000
#scoreboard players operation #x int += #random int
#execute store result entity @s Motion[0] double 0.001 run scoreboard players get #x int
